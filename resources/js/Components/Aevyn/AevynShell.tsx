    ...
    const [messages, setMessages] = useState<AevynMessage[]>([
        {
            ...
            role: 'assistant',
            content:
                "Hi, I'm Aevyn. I can help with workforce insights, competency, learning, performance, and development.",
        },
    ]);
                                    ...
                                    {!hasConversation ? (
                                        <div className="flex min-h-full flex-col items-center justify-center px-5 py-8">
                                            <img
                                                ...
                                                alt=""
                                                aria-hidden="true"
                                                className="mb-5 h-[78px] w-[78px] select-none object-contain drop-shadow-sm"
                                                draggable={false}
                                            />
                                            ...
                                            <p className="mt-2 max-w-[310px] text-center text-xs leading-5 text-slate-500">
                                                Ask about performance, competency,
                                                learning, workforce development, or the
                                                module you&apos;re currently viewing.
                                            </p>
