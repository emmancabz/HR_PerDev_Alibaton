                    ...
                    <div className="app-card overflow-hidden">
                        ...
                        <div className="space-y-3 p-4">
                            {dashboard.workforceByDepartment.length ? dashboard.workforceByDepartment.slice(0, 7).map((item) => {
                                ...
                                return (
                                    <Link prefetch key={item.department} href={route('admin.users.index', { department: item.department })} className="group block rounded-lg p-1 -m-1 transition hover:bg-slate-50">
