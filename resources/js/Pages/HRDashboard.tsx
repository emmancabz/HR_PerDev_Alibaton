...
const quickAccess = [
    { label: 'Users', icon: Users, href: () => route('hr.users.index') },
    { label: 'Performance', icon: Star, href: () => route('hr.performance.index') },
    { label: 'Competency', icon: Target, href: () => route('hr.competency.index') },
    { label: 'Learning', icon: BookOpenCheck, href: () => route('hr.learning.index') },
    { label: 'Training', icon: GraduationCap, href: () => route('hr.training.index') },
    { label: 'Succession', icon: UserRoundCheck, href: () => route('hr.succession.index') },
    { label: 'Recognition', icon: Award, href: () => route('hr.recognition.index') },
    { label: 'Reports', icon: BriefcaseBusiness, href: () => route('hr.reports.index') },
];
...
export default function HRDashboard({ userName = 'HR Personnel', dashboard }: Props) {
    ...
    const kpis: KpiDefinition[] = [
        ...
        },
        {
            ...
            icon: Target,
            href: `${route('hr.competency.index')}#Assessments`,
            attention: true,
        },
        {
            ...
            icon: GraduationCap,
            href: `${route('hr.training.index')}#Overview`,
            attention: true,
        },
        {
            ...
            icon: UserRoundCheck,
            href: `${route('hr.succession.index')}#Succession%20Register`,
            attention: true,
        },
        {
            ...
            icon: Award,
            href: `${route('hr.recognition.index')}#Review%20Queue`,
            attention: true,
        },
    ];
        ...
        <AuthenticatedLayout
            header={
                <div className="min-w-0">
                    ...
                    <p className="mt-0.5 truncate text-xs text-slate-500">HR Performance & Development operations center</p>
                </div>
            }
        >
            ...
            <div className="app-page app-page-enter space-y-5">
                <section className="app-card flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                        ...
                        <h2 className="mt-1 truncate text-lg font-extrabold text-slate-950">{greeting()}, {userName}</h2>
                        <p className="mt-1 text-xs text-slate-500">Manage people, performance, capability, learning, training, succession, recognition, and workforce reporting from one HR operations view.</p>
                    </div>
                    <Link
                        href={route('hr.users.index')}
                        prefetch
                        className="inline-flex h-9 shrink-0 items-center justify-center rounded-lg bg-[#F4B400] px-3.5 text-xs font-extrabold text-slate-950 transition hover:bg-[#dda300]"
                    >
                        Open Personnel
                    </Link>
                </section>
                ...
                <section className="grid grid-cols-1 gap-5 xl:grid-cols-3">
                    ...
                    <div className="app-card overflow-hidden">
                        <SectionHeader
                            ...
                            description="Highest-priority HR governance actions."
                        />
                ...
                <section className="app-card overflow-hidden">
                    <SectionHeader
                        ...
                        href={`${route('hr.performance.index')}#Overview`}
                ...
                <section className="grid grid-cols-1 gap-5 lg:grid-cols-3">
                    <div className="app-card overflow-hidden">
                        <SectionHeader title="Personnel by Department" description={`${workforceTotal} active personnel`} href={route('hr.users.index')} action="Open personnel" />
                    ...
                    <div className="app-card overflow-hidden">
                        <SectionHeader title="Recent Activity" description="Latest HR-governed events" />
                ...
                <section className="app-card overflow-hidden">
                    <SectionHeader title="Quick Access" description="Jump directly to the HR Performance & Development workspaces." />
