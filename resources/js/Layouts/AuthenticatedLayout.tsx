...
const userNavItems: NavItem[] = [
    ...
    },
    {
        ...
        icon: FileText,
        routeName: 'user.transcripts.index',
    },
...
const adminNavItems: NavItem[] = [
    ...
    { label: 'Users', icon: Users, routeName: 'admin.users.index' },
    {
        label: 'Performance',
        icon: TrendingUp,
        routeName: 'admin.performance.index',
    },
    {
        label: 'Competency',
        icon: Settings2,
        routeName: 'admin.competency.index',
    },
    {
        label: 'Learning',
        icon: GraduationCap,
        routeName: 'admin.learning.index',
    },
    {
        label: 'Training',
        icon: BookOpen,
