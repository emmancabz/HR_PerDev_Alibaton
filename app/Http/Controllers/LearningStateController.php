...
class LearningStateController extends Controller
{
    ...
    public function issueCertificate(Request $request, string $completion): JsonResponse { $certificate = $this->delivery->issueCertificate($request->user(), $completion); return response()->json(['data' => ['certificateId' => $certificate->id]]); }
